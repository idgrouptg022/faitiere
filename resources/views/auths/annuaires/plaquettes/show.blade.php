...
<div class="container">
                        ...
                        <figure class="responsable-image">
                            ...
                            <figcaption>
                                ...
                                <div class="banner-actions">
                                    ...
                                    <a href="#!" onclick="event.preventDefault(); confirm('Etes-vous sûr de vouloir supprimer cette image ?') ? document.getElementById('deleteImage').submit() : ''">Supprimer</a>
                        ...
                        <figure class="responsable-image">
                            ...
                            <figcaption>
                                ...
                                <div class="banner-actions">
                                    ...
                                    <a href="#!" onclick="event.preventDefault(); confirm('Etes-vous sûr de vouloir supprimer cette image ?') ? document.getElementById('deleteImageResp1').submit() : ''">Supprimer</a>
                        ...
                        <figure class="responsable-image">
                            ...
                            <figcaption>
                                ...
                                <div class="banner-actions">
                                    ...
                                    <a href="#!" onclick="event.preventDefault(); confirm('Etes-vous sûr de vouloir supprimer cette image ?') ? document.getElementById('deleteImageResp2').submit() : ''">Supprimer</a>
    ...
    <form action="{{ route('auth:annuaires:destroy-responsable-image', [$commune, $annuaireResponsableMaire->type ?? 'default-type'] ) }}" method="POST" id="deleteImage">
        @csrf
        @method("DELETE")
    </form>
    <form action="{{ route('auth:annuaires:destroy-responsable-image', [$commune, $annuaireResponsableAdjoint1->type ?? 'default-type'] ) }}" method="POST" id="deleteImageResp1">
        @csrf
        @method("DELETE")
    </form>
    <form action="{{ route('auth:annuaires:destroy-responsable-image', [$commune, $annuaireResponsableAdjoint2->type ?? 'default-type'] ) }}" method="POST" id="deleteImageResp2">
        @csrf
        @method("DELETE")
    </form>
</div>
