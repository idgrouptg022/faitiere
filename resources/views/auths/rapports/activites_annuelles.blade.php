...
@push('extra-styles')
<link rel="stylesheet" href="{{ asset('assets/styles/auths/rapports/activites_annuelles.css') }}">
@endpush

@section('content')
<h1 class="page-title">Rapports des activités annuelles</h1>
...
<div class="container">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('auth:rapports-activites:destroy', $rapport) }}" method="POST" id="deleteEvent{{ $rapport->id }}">
                            @csrf
                            @method("DELETE")
                        </form>
                    </td>
    ...
    <div class="modal__container" id="editRapport{{ $rapport->id }}">
        <div class="modal">
            <div class="modal__body">
                <form action="{{ route('auth:rapports-activites:update', $rapport) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method("PATCH")
                    ...
                    <input type="hidden" name="type" value="activites-annuelles">
    ...
    <div class="modal__container" id="addRapport">
        <div class="modal">
            <div class="modal__body">
                <form action="{{ route('auth:rapports-activites:store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form__group">
                        <label for="title" class="form__label">Titre</label>
