...
@section('content')
    ...
    <div class="container">
        ...
        <div class="event-container">
            <div class="form-part">
                <form action="{{ route('auth:evenements:store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form__group">
                        <label for="title" class="form__label">Titre</label>
                        <input type="text" name="title" id="title" placeholder="Titre de l'événement..." class="input__form">
                    </div>
                    <div class="form__group">
                        <label for="domaine" class="form__label">Domaine</label>
                        <input type="text" name="domaine" id="domaine" placeholder="Culture, politique, environnement,..." class="input__form">
                    </div>
                    <div class="form__row">
                        <div class="form__col">
                            <label for="event_date" class="form__label">Date</label>
                            <input type="date" name="event_date" id="event_date" class="input__form">
                        </div>
                        <div class="form__col">
