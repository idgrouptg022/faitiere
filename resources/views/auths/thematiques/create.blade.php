...
<div class="container">
    ...
    <div class="event-container">
        <div class="form-part">
            <form action="{{ route('auth:thematiques:store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form__group">
                    <label for="title" class="form__label">Titre</label>
                    <input type="text" name="title" id="title" placeholder="Titre de la thématique..." class="input__form">
                </div>
                ...
                <div class="form__group">
                    ...
                    <textarea name="description" id="content" rows="3" placeholder="Description de la thématique..." class="input__form"></textarea>
                </div>
