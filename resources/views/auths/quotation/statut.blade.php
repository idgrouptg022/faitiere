    ...
    <div class="container">
        ...
        <div class="page-content">
            ...
            <div class="quotation-container">
                <div class="form-part">
                    <form action="{{ route('auth:about:store', 'statut') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form__button">
                            <button type="submit" class="button__green">Enregistrer le statut</button>
                        </div>
                    </form>
                </div>
