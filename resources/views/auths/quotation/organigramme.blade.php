    ...
    <div class="container">
        ...
        <div class="page-content">
            ...
            <div class="quotation-container">
                <div class="form-part">
                    <form action="{{ route('auth:about:store', 'organigramme') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form__button">
                            <button type="submit" class="button__green">Enregistrer l'organigramme</button>
                        </div>
                    </form>
                </div>
...
@push('extra-scripts')
    ...
    <script>
        $(document).ready(function() {
            $('#content').summernote({
                placeholder: "Contenu de l'organigramme...",
                lang: 'fr-FR',
                height: 300,
                toolbar: [
                    ['style', ['style']],
