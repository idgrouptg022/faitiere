...
@section('content')
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <figure class="slide-img">
                            <img src="{{ asset('assets/images/banniere.jpg') }}" alt="Slide 1">
                            <figcaption class="banniere-mask">
                                <div class="banniere-band">
                                    <div class="banniere-logo">
                                        <img src="{{ asset('assets/images/logo.png') }}" alt="Logo FCT" class="">
                                    </div>
                                    <h2 class="banniere-title">Bienvenue sur le site web officiel de la faitiere des communes du Togo</h2>
                                    <p class="banniere-description">Le cadre d'échange, de partage d'informations, d'expériences entre les communes Togolaises</p>
                    ...
                    <div class="swiper-slide">
                        <figure class="slide-img">
                            <img src="{{ asset('assets/images/banner2.jpg') }}" alt="Slide 1">
                            <figcaption class="banniere-mask">
                                <div class="banniere-band band-2">
                                    <div class="banniere-logo">
                                        <img src="{{ asset('assets/images/logo-white.png') }}" alt="Logo FCT" class="">
                                    </div>
                                    <h2 class="banniere-title">Bienvenue sur le site web officiel de la faitiere des communes du Togo</h2>
                                    <p class="banniere-description">Le cadre d'échange, de partage d'informations, d'expériences entre les communes Togolaises</p>
                                    <a href="https://communestogo.test" class="banniere-btn">Consulter l'annuaire <i class="fas fa-arrow-right"></i></a>
    ...
    <section class="presentation-section section-container">
        ...
        <div class="presentation-content">
            <h2 class="presentation-title">La faitiere des communes du Togo</h2>
        ...
        <div class="localisation-ads-container">
            <div class="map-localisation-container">
                ...
                <div class="region-desc" id="maritime-desc">
                    ...
                    <p>Superficie: 6100 km2</p>
                    <p>xxxxxxx habitants</p>
                    <div class="region-button">
                        <a href="#" class="button-link">Localisation</a>
                    </div>
                </div>
                <div class="region-desc" id="plateau-desc">
                    <h4 class="region-desc-title">Region des plateaux</h4>
                    <p>Superficie: 16 975 km2</p>
                    <p>xxxxxxx habitants</p>
                    <div class="region-button">
                        <a href="#" class="button-link">Localisation</a>
                    </div>
            ...
            <div class="ads-container">
                <div class="twitter-widget-container">
                    <blockquote class="twitter-tweet">
                        <p lang="fr" dir="ltr">
                            <a href="https://twitter.com/hashtag/Culture?src=hash&amp;ref_src=twsrc%5Etfw">#Culture</a>
                            <a href="https://twitter.com/hashtag/Traditions?src=hash&amp;ref_src=twsrc%5Etfw">#Traditions</a>
                            <br><br>Honneur d’avoir représenté le chef de l’État, SEM
                            <a href="https://twitter.com/FEGnassingbe?ref_src=twsrc%5Etfw">@FEGnassingbe</a>,
                            et plaisir d’avoir communié avec les communautés Aflao, Agoè Nyive et Bè du grand Lomé lors de la célébration apothéose de
                            <a href="https://twitter.com/hashtag/Dunenyoza2024?src=hash&amp;ref_src=twsrc%5Etfw">#Dunenyoza2024</a>.
                            <br><br>Mutualiser et valoriser le patrimoine culturel tout… <a href="https://t.co/WnsoGgAuyF">pic.twitter.com/WnsoGgAuyF</a>
                        </p>&mdash; Yawa A. Kouigan (@YawaKouigan) <a href="https://twitter.com/YawaKouigan/status/1825109406448529808?ref_src=twsrc%5Etfw">August 18, 2024</a>
                    </blockquote>
                </div>
                <div class="pub-content">
                    <figure class="pub-image">
                        <img src="{{ asset('assets/images/ads2.png') }}" alt="Image de publicité" loading="lazy">
                    </figure>
                </div>
            </div>
        </div>
            ...
            <div class="partners">
                ...
                <div class="partners-logo">
                    <div class="partners-logo-wrapper">
                        ...
                        <figure class="partner-slide animated-bg">
                            <img src="{{ asset('assets/images/partners/8.png') }}" alt="Logo du partenaire" loading="lazy">
                        </figure>
                        <figure class="partner-slide animated-bg">
                            <img src="{{ asset('assets/images/partners/9.png') }}" alt="Logo du partenaire" loading="lazy">
                        </figure>
                        <figure class="partner-slide animated-bg">
                            <img src="{{ asset('assets/images/partners/10.png') }}" alt="Logo du partenaire" loading="lazy">
                        </figure>
                        <figure class="partner-slide animated-bg">
                            <img src="{{ asset('assets/images/partners/11.jpg') }}" alt="Logo du partenaire" loading="lazy">
                        </figure>
                        <figure class="partner-slide animated-bg">
                            <img src="{{ asset('assets/images/partners/12.png') }}" alt="Logo du partenaire" loading="lazy">
                        </figure>
                        <figure class="partner-slide animated-bg">
                            <img src="{{ asset('assets/images/partners/1.png') }}" alt="Logo du partenaire" loading="lazy">
                        </figure>
