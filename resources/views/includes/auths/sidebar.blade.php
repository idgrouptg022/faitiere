<aside>
    ...
    <div class="sidebar-links">
        <ul>
            ...
            <li>
                <a href="{{ route('auth:thematiques:index') }}" title="thematique" class="tooltip">
                    <svg  viewBox="0 0 192 512" xmlns="http://www.w3.org/2000/svg">
                        <path d="M48 80a48 48 0 1 1 96 0A48 48 0 1 1 48 80zM0 224c0-17.7 14.3-32 32-32H96c17.7 0 32 14.3 32 32V448h32c17.7 0 32 14.3 32 32s-14.3 32-32 32H32c-17.7 0-32-14.3-32-32s14.3-32 32-32H64V256H32c-17.7 0-32-14.3-32-32z"></path>
                      </svg>
                    <span class="link hide">Thématiques</span>
                    <span class="tooltip__content">Thématiques</span>
                </a>
            </li>
            {{-- <li>
                <a href="{{ route('auth:prefectures:index') }}" title="prefectures" class="tooltip">
                    <svg  viewBox="0 0 640 512" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
                <a href="{{ route('auth:communes:index') }}" title="communes" class="tooltip">
                    <svg  viewBox="0 0 640 512" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
                <a href="{{ route('auth:maploc:index') }}" title="map communes" class="tooltip">
                    <svg viewBox="0 0 384 512" xmlns="http://www.w3.org/2000/svg">
                        <path d="M215.7 499.2C267 435 384 279.4 384 192C384 86 298 0 192 0S0 86 0 192c0 87.4 117 243 168.3 307.2c12.3 15.3 35.1 15.3 47.4 0zM192 128a64 64 0 1 1 0 128 64 64 0 1 1 0-128z"></path>
                    </svg>
                    <span class="link hide">Map communes</span>
                    <span class="tooltip__content">Map communes</span>
                </a>
            </li>

            <li>
                <a href="{{ route('auth:partner:index') }}" title="partenaires" class="tooltip">
                    <svg viewBox="0 0 640 512" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span class="link hide">Partenaires</span>
                    <span class="tooltip__content">Partenaires</span>
                </a>
            </li>

            <li>
                <a href="{{ route('auth:publicites:index') }}" title="publicites" class="tooltip">
                    <svg  viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span class="link hide">Publicités</span>
                    <span class="tooltip__content">Publicités</span>
                </a>
            </li>

            <li>
                <a href="{{ route('auth:twitter:index') }}" title="twitter" class="tooltip">
                    <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                        <path d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z"></path>
                    </svg>
                    <span class="link hide">Twitter Post</span>
                    <span class="tooltip__content">Twitter Post</span>
                </a>
            </li>
            ...
            <li>
                <a href="{{ route('auth:about:index', 'role-mission') }}" title="Valeurs et Mission" class="tooltip">
                    <svg viewBox="0 0 576 512" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0 80v48c0 17.7 14.3 32 32 32H48 96V80c0-26.5-21.5-48-48-48S0 53.5 0 80zM112 32c10 13.4 16 30 16 48V384c0 35.3 28.7 64 64 64s64-28.7 64-64v-5.3c0-32.4 26.3-58.7 58.7-58.7H480V128c0-53-43-96-96-96H112zM464 480c61.9 0 112-50.1 112-112c0-8.8-7.2-16-16-16H314.7c-14.7 0-26.7 11.9-26.7 26.7V384c0 53-43 96-96 96H368h96z"></path>
                    </svg>
                    <span class="link hide">Valeurs et Mission</span>
                    <span class="tooltip__content">Valeurs et Mission</span>
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="{{ route('auth:ressources:view') }}" title="Centre national de ressources" class="tooltip">
                    ...
                    <span class="link hide">CNR</span>
                    <span class="tooltip__content">CNR</span>
                </a>
            </li>
            <li>
                <a href="{{ route('auth:rapports-ag:index') }}" title="Rapports d'assemblée générale" class="tooltip">
                    ...
                    <span class="link hide">Rapports AG</span>
                    <span class="tooltip__content">Rapports AG</span>
                </a>
            </li>
            <li>
                <a href="{{ route('auth:activites_annuelles:view') }}" title="Rapports d'activités annuelles" class="tooltip">
                    ...
                    <span class="link hide">Rapports AN</span>
                    <span class="tooltip__content">Rapports AN</span>
                </a>
            </li>
            ...
            <h6 style="font-family: montserrat-bold;">Annuaire Communes Togo</h6>
            <li>
                <a href="{{ route('auth:annuaires:communes') }}" title="Communes" class="tooltip">
                    <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
                <a href="{{ route('auth:annuaires:plaquettes:index') }}" title="Plaquettes" class="tooltip">
                    <svg viewBox="0 0 640 512" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span class="link hide">Plaquettes</span>
                    <span class="tooltip__content">Plaquettes</span>
                </a>
            </li>
            <li>
                <a href="{{ route('auth:annuaires:annonces:index') }}" title="Annonces" class="tooltip">
                    <svg  viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                        <path d="M480 32c0-12.9-7.8-24.6-19.8-29.6s-25.7-2.2-34.9 6.9L381.7 53c-48 48-113.1 75-181 75H192 160 64c-35.3 0-64 28.7-64 64v96c0 35.3 28.7 64 64 64l0 128c0 17.7 14.3 32 32 32h64c17.7 0 32-14.3 32-32V352l8.7 0c67.9 0 133 27 181 75l43.6 43.6c9.2 9.2 22.9 11.9 34.9 6.9s19.8-16.6 19.8-29.6V300.4c18.6-8.8 32-32.5 32-60.4s-13.4-51.6-32-60.4V32zm-64 76.7V240 371.3C357.2 317.8 280.5 288 200.7 288H192V192h8.7c79.8 0 156.5-29.8 215.3-83.3z"></path>
                    </svg>
                    <span class="link hide">Annonces</span>
                    <span class="tooltip__content">Annonces</span>
                </a>
            </li>
